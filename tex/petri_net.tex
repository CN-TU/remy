...
%  \tikzstyle{every label}=[blue!75]
  ...
  \begin{scope}
    \node [place,tokens=1] (s1) at (0, 1) [label={[align=center]left:Receive\\ feedback}] {};
    \node [place] (s2) at (1, 2) [label={[align=center]above:Received\\ ACK}] {};
    ...
    \node [transition] (e5) at (0, 2) [label={[align=center]left:Received\\ feedback}] {}
      edge [pre] node {1} (s2)
      edge [post] node {1} (s1);
